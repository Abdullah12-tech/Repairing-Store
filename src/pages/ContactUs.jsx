    ...
    <section className="min-h-screen bg-[rgb(var(--secondary))] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden shadow-2xl bg-[rgba(var(--primary),0.5)] border border-[rgba(var(--tertiary),0.2)]">
          ...
          <div className="relative bg-primary p-8 lg:p-12 flex flex-col gap-5">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 mb-6">
                ...
                <span className="text-[rgb(var(--tertiary))] text-sm font-medium tracking-widest uppercase">
                  Get in Touch
                </span>
              </div>
              
              <h1 className="text-4xl lg:text-5xl font-bold text-[rgb(var(--secondary))] leading-tight mb-4">
                Let's Start a<br />
                <span className="text-[rgb(var(--tertiary))]">Conversation</span>
              </h1>
              
              <p className="text-[rgb(var(--secondary))] opacity-70 text-lg max-w-md leading-relaxed">
              ...
              {contactInfo.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[rgb(var(--secondary))] text-sm font-medium truncate">
                      {item.value}
                    </div>
                  </div>
                  <svg 
                    className="w-5 h-5 text-[rgb(var(--secondary))] opacity-0 group-hover:opacity-100 transform translate-x-[-10px] group-hover:translate-x-0 transition-all duration-300" 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                  >
          ...
          {/* Right Side - Form */}
          <div className="p-8 border-none lg:p-12 bg-[rgba(var(--primary))] backdrop-blur-sm">
            <div className="max-w-lg mx-auto">
              <div className="mb-8 ">
                <h2 className="text-2xl lg:text-3xl font-bold text-[rgb(var(--secondary))] mb-2">
                  Send a Message
                </h2>
                <p className="text-[rgb(var(--secondary))] opacity-60 text-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="relative w-full py-4 px-6 bg-[rgb(var(--tertiary))] text-[rgb(var(--primary))] font-semibold rounded-lg overflow-hidden transition-all duration-500 hover:shadow-[0_0_30px_rgba(var(--tertiary),0.4)] hover:scale-[1.02] disabled:cursor-not-allowed disabled:opacity-70"
                >
                  <span className={`flex items-center justify-center gap-2 transition-all duration-500 ${isSubmitting || isSubmitted ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
                    Send Message
                ...
                <div className="flex items-center justify-center gap-6 pt-4 opacity-40">
                  <div className="flex items-center gap-2 text-[rgb(var(--secondary))] text-xs">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                    <span>256-bit SSL</span>
                  </div>
                  <div className="w-1 h-1 rounded-full bg-[rgb(var(--secondary))]" />
                  <div className="flex items-center gap-2 text-[rgb(var(--secondary))] text-xs">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
